...
<html lang="en">
	...
	<head><base href="">
		...
		<link rel="shortcut icon" href="{{ asset('metronic/src/assets/media/logos/favicon.ico') }}" />
		<!--begin::Fonts-->
		...
		<link href="{{ asset('metronic/src/assets/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		...
		<script src="{{ asset('metronic/src/assets/plugins/global/plugins.bundle.js') }}"></script>
		<script src="{{ asset('metronic/src/assets/js/scripts.bundle.js') }}"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="{{ asset('metronic/src/assets/plugins/custom/leaflet/leaflet.bundle.js') }}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{ asset('metronic/src/assets/js/custom/modals/select-location.js') }}"></script>
