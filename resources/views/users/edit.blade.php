	...
	<div class="container-xxl" id="kt_content_container">
				...
				<div class="card mb-5 mb-xl-8">
					...
					<div class="card-body pt-15">
						...
						<div class="d-flex flex-center flex-column mb-5">
							...
							<img src="{{ asset('storage/'.$item->profile_photo_path) }}" alt="image" />
							</div>
							<!--end::Avatar-->
							<!--begin::Name-->
							<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">{{ $item->name }}</a>
							<!--end::Name-->
							<!--begin::Position-->
							<div class="fs-5 fw-bold text-muted mb-6">{{ $item->role}}</div>
							<!--end::Position-->
							<!--begin::Info-->
							<div class="d-flex flex-wrap flex-center">
								...
								<div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
									<div class="fs-4 fw-bolder text-gray-700">
										<span class="w-75px">Rp. {{ $item->balance }}</span>
								...
								<div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3">
									...
									<div class="fw-bold text-muted">Withdraws</div>
								</div>
								<!--end::Stats-->
							</div>
							<!--end::Info-->
					...
					<div class="tab-pane fade show active" id="kt_customer_view_overview_tab" role="tabpanel">
								...
								<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
									...
									<tbody class="fs-6 fw-bold text-gray-600">
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">9603-4275</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">8263-8473</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">9001-3668</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">3136-6669</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">3319-4578</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">7037-2358</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">4185-8194</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">1233-5397</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
										...
										<tr>
											<!--begin::Invoice=-->
											<td>
												<a href="#" class="text-gray-600 text-hover-primary mb-1">4169-5355</a>
											</td>
											<!--end::Invoice=-->
											<!--begin::Status=-->
											<td>
						...
						<div class="card pt-4 mb-6 mb-xl-9">
							...
							<div class="card-body pt-0">
								<div class="fw-bolder fs-2">Rp. {{ $item->balance }}
								<span class="text-muted fs-4 fw-bold">IDR</span>
									...
									<table class="table align-middle table-row-dashed fw-bold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
										...
										<tbody>
											...
											<tr>
												...
												<!--end::Badge=-->
												<!--begin::Status=-->
												<td>POST /v1/invoice/in_9499_4576/invalid</td>
												<!--end::Status=-->
												<!--begin::Timestamp=-->
												<td class="pe-0 text-end min-w-200px">05 May 2021, 6:43 am</td>
												<!--end::Timestamp=-->
											</tr>
											<!--end::Table row-->
											<!--begin::Table row-->
											<tr>
												...
												<!--end::Badge=-->
												<!--begin::Status=-->
												<td>POST /v1/invoices/in_5610_7406/payment</td>
												<!--end::Status=-->
												<!--begin::Timestamp=-->
												<td class="pe-0 text-end min-w-200px">21 Feb 2021, 8:43 pm</td>
												<!--end::Timestamp=-->
											</tr>
											<!--end::Table row-->
											<!--begin::Table row-->
											...
											<tr>
												...
												<!--end::Badge=-->
												<!--begin::Status=-->
												<td>POST /v1/customer/c_614859dd8c501/not_found</td>
												<!--end::Status=-->
												<!--begin::Timestamp=-->
												<td class="pe-0 text-end min-w-200px">05 May 2021, 6:43 am</td>
												<!--end::Timestamp=-->
											...
											<tr>
												...
												<!--end::Badge=-->
												<!--begin::Status=-->
												<td>POST /v1/invoice/in_8465_5185/invalid</td>
												<!--end::Status=-->
												<!--begin::Timestamp=-->
											...
											<tr>
												...
												<!--end::Badge=-->
												<!--begin::Status=-->
												<td>POST /v1/invoices/in_7850_3651/payment</td>
												<!--end::Status=-->
												<!--begin::Timestamp=-->
												<td class="pe-0 text-end min-w-200px">20 Dec 2021, 9:23 pm</td>
												<!--end::Timestamp=-->
											</tr>
											<!--end::Table row-->
											<!--begin::Table row-->
											<tr>
												...
												<!--end::Badge=-->
												<!--begin::Status=-->
												<td>POST /v1/invoice/in_5542_5176/invalid</td>
												<!--end::Status=-->
												<!--begin::Timestamp=-->
								...
								<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5" id="kt_table_customers_events">
									...
									<tbody>
										...
										<tr>
											...
											<!--end::Event=-->
											<!--begin::Timestamp=-->
											<td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 5:20 pm</td>
											<!--end::Timestamp=-->
										</tr>
										<!--end::Table row-->
										<!--begin::Table row-->
										...
										<tr>
											...
											<!--end::Event=-->
											<!--begin::Timestamp=-->
											<td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2021, 5:20 pm</td>
											<!--end::Timestamp=-->
										</tr>
										<!--end::Table row-->
										<!--begin::Table row-->
		...
		<div class="modal fade" id="kt_modal_update_customer" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					<!--begin::Form-->
					<form class="form" action="{{ route('users.update', $item->id) }}" method="POST" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						<!--begin::Modal header-->
							...
							<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_customer_header" data-kt-scroll-wrappers="#kt_modal_update_customer_scroll" data-kt-scroll-offset="300px">
								...
								<div id="kt_modal_update_customer_user_info" class="collapse show">
									...
									<div class="fv-row mb-7">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" class="form-control form-control-solid" placeholder="{{ $item->name }}" name="name" value="{{ old('name') ?? $item->name }}" required/>
										<!--end::Input-->
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="fv-row mb-7">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="email" class="form-control form-control-solid" placeholder="{{ $item->email }}" name="email" value="{{ old('email') ?? $item->email }}" required/>
										<!--end::Input-->
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="fv-row mb-7">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="password" class="form-control form-control-solid" placeholder="Password" name="password" required autocomplete="new-password" value="{{ old('password') }}" />
										<!--end::Input-->
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="fv-row mb-7">
										...
										<input class="form-control form-control-solid" id="password_confirmation" value="{{ old('password_confirmation') }}" type="password" placeholder="Re-type the password" name="password_confirmation" required autocomplete="new-password" />
									</div>
									<input class="form-control form-control-solid" id="role" type="hidden" name="role" value="{{ $item->role }}"/>
									<!--end::Input group-->
								</div>
								<!--end::User form-->
								<!--begin::Billing toggle-->
								<div class="fw-bolder fs-3 rotate collapsible collapsed mb-7" data-bs-toggle="collapse" href="#kt_modal_update_customer_billing_info" role="button" aria-expanded="false" aria-controls="kt_modal_update_customer_billing_info">Additional Information
								<span class="ms-2 rotate-180">
									<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
									<span class="svg-icon svg-icon-3">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
@push('scripts')
	...
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/view/add-payment.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/view/adjust-balance.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/view/invoices.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/view/payment-method.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/view/payment-table.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/view/statement.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/apps/customers/update.js') }}"></script>
	<script src="{{ asset('metronic/src/assets/js/custom/modals/new-card.js') }}"></script>
